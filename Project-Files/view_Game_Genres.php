...
session_start();
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link nav_text active" href="./view_Game_Genres.php">View Game Genres</a>
      </li>
      <li class="nav-item">
    ...
    try{
		$stmt_2 = $DBH->prepare('SELECT Genres.Game_ID, Game_Name, Genre FROM Genres, Games_list WHERE Genres.Game_ID = Games_List.Game_ID');
