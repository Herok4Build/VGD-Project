...
session_start();
  ...
  <div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link nav_text active" href="./view_Game_Systems.php">View Game Systems</a>
      </li>
      <li class="nav-item">
    ...
    try{
		$stmt_2 = $DBH->prepare('SELECT Systems.Game_ID, Game_Name, System FROM Systems, Games_list WHERE Systems.Game_ID = Games_List.Game_ID');
		$stmt_2->execute();
